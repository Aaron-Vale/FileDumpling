...
var createEnc = function createEnc(data) {
  return $.ajax({
    // ajax options go here
  });
};
var createMulti = function createMulti(formData) {
  return $.ajax({
    headers: {
...
var editUpload = function editUpload(id, data) {
  var token = store.user.token;
  return $.ajax({
...
var showUploadsTemplate = __webpack_require__(18);

var failureSound = $('#failureSound')[0];
...
var onGetUploadsSuccess = function onGetUploadsSuccess(data) {
  var showUploadsHtml = showUploadsTemplate({ uploads: data.uploads });
  $('.uploads-table').empty();
  ...
  $('.hashtag').on('click', function () {
    ...
    $('.uploads-table').html('');
    api.getUploads(value).then(onGetUploadsSuccess).catch(onGetUploadsFailure);
  });
};

var onGetUploadsFailure = function onGetUploadsFailure() {
  $('#message_02').show();
  $('#message_02').text('Error on getting files. Try again.').fadeOut(3000);
};

var onEditUpload = function onEditUpload() {
  var elementId = $(this).parent().parent().attr('data-id');
  var fileName = $(this).parent().siblings()[0];
  var tags = $(this).parent().siblings()[2];
  ...
  $(fileName).keydown(function (e) {
    // Prevent user from adding new lines in table
    if (e.which === 13) {
      // 13 --> enter key
      fileName.blur();
    }
...
var onConfirmEdit = function onConfirmEdit(elementId, fileName, tags) {
  var newFileName = $(fileName).html();
  var newTags = $(tags).html().replace(/[^a-z0-9 ]/gi, '').split(' ');
  if (newTags[0] === '') {
    newTags = null;
  }
  var data = {
  ...
  api.editUpload(elementId, data).then(onEditUploadSuccess).catch(onEditUploadFailure);
};

var onEditUploadSuccess = function onEditUploadSuccess(data) {
  successSound.play();
  $('#message_02').show();
...
var onEditUploadFailure = function onEditUploadFailure() {
  $('#message_02').show();
...
var onDeleteUpload = function onDeleteUpload() {
  ...
  var editBtn = $(this).siblings()[0];
  $(editBtn).remove();
  $(this).remove();
  $('.confirm-delete-btn').on('click', function () {
    api.deleteUpload(elementId).then(onDeleteUploadSuccess).catch(onDeleteUploadFailure);
  });
...
var onDeleteUploadSuccess = function onDeleteUploadSuccess(data) {
  successSound.play();
  resetTable();
  $('#message_02').show();
...
var onDeleteUploadFailure = function onDeleteUploadFailure() {
  failureSound.play();
  $('#message_02').show();
...
var resetTable = function resetTable() {
  $('.uploads-table').html('');
  api.getUploads().then(onGetUploadsSuccess).catch(onGetUploadsFailure);
};
...
module.exports = {
  ...
  onGetUploadsFailure: onGetUploadsFailure,
  onEditUpload: onEditUpload,
  onEditUploadFailure: onEditUploadFailure,
  onDeleteUpload: onDeleteUpload,
  onDeleteUploadSuccess: onDeleteUploadSuccess,
  onDeleteUploadFailure: onDeleteUploadFailure,
...
var uploadEvents = __webpack_require__(36);
var successSound = $('#successSound')[0];
...
var store = __webpack_require__(4);
var uploadApi = __webpack_require__(5);
var uploadUi = __webpack_require__(7);
...
var signInSuccess = function signInSuccess(data) {
  ...
  uploadApi.getUploads().then(uploadUi.onGetUploadsSuccess).catch(uploadUi.onGetUploadsFailure);
};
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "\n<tr data-id=\""
    ...
    + "</td>\n  <td>"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.uploadedBy : stack1), depth0))
    + "</td>\n  <td class=\"td-tags\">\n"
    + ((stack1 = helpers.each.call(alias3,((stack1 = blockParams[0][0]) != null ? stack1.tags : stack1),{"name":"each","hash":{},"fn":container.program(2, data, 0, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    ...
    + "\"<button class=\"btn btn-success\">Download</button></a></td>\n  <td>\n"
    + ((stack1 = helpers["if"].call(alias3,((stack1 = blockParams[0][0]) != null ? stack1.editable : stack1),{"name":"if","hash":{},"fn":container.program(4, data, 0, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "  </td>\n</tr>\n\n";
},"2":function(container,depth0,helpers,partials,data) {
    return "      <a class=\"hashtag\">#"
    + container.escapeExpression(container.lambda(depth0, depth0))
    + " </a>\n";
},"4":function(container,depth0,helpers,partials,data) {
    return "      <button class=\"edit-btn btn btn-info\">Edit</button>\n      <button class=\"delete-btn btn btn-danger\">Delete</button>\n";
},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1;

  return "<button class=\"btn btn-success align-right\" id=\"refresh\">Refresh List</button>\n<table class=\"table\">\n  <thead class=\"thead-inverse\">\n    <tr>\n      <th>File Name</th>\n      <th>Uploaded By</th>\n      <th>Tags</th>\n      <th>Date Created</th>\n      <th>Date Modified</th>\n      <th>Download</th>\n      <th>Options</th>\n    </tr>\n  </thead>\n  <tbody class=\"table-body\">\n\n"
...
var createUploadMultiPart = function createUploadMultiPart(event) {
  ...
  uploadApi.createMulti(formData).then(uploadUi.success).catch(uploadUi.error);
};
